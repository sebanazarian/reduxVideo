...
const composerEnhancers = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose; //PARA DEBUGUEAR LA APP
const store = createStore(reducer, initialState,composerEnhancers());
